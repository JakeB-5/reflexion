...
function getGlobalDir() {
  return join(process.env.HOME, '.reflexion');
}
function getDataDir() {
  return join(getGlobalDir(), 'data');
}
function getDbPath() {
  return join(getDataDir(), 'reflexion.db');
}
...
const DEFAULT_DB_PATH = join(process.env.HOME, '.reflexion', 'data', 'reflexion.db');
...
const DEFAULT_SOCKET_PATH = '/tmp/reflexion-embed.sock';
