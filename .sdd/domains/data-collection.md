...
> Phase 1: 데이터 수집 레이어 — 훅 스크립트를 통해 프롬프트, 도구 사용, 에러, 세션 요약을 JSONL에 기록
...
### 유틸리티 (lib/)
- `log-writer.mjs` — JSONL 읽기/쓰기, 로테이션, stdin 파싱, 세션 인덱스
...
| 스펙 | 파일 | REQ 범위 | 의존성 |
|------|------|----------|--------|
| log-writer | `specs/data-collection/log-writer/spec.md` | REQ-DC-001~006 | 없음 |
